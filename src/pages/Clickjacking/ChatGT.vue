...
<style scoped>
  ...
  .hidden-text-content span {
    font-weight: 900;
  }

  .hidden-text-content .btn-like, .hidden-text-content .btn-liked {
    background: #C42FF9;
  }

  .hidden-text-content .btn-like:hover, .hidden-text-content .btn-liked:hover {
    background: #a64fc6;
  }
</style>
