  ...
  data() {
    return {
      ...
      descriptionTypes: [
        ...
        {
          description: '<b class="strong-text">8. Соблюдение стандартов безопасности:</b> Следуйте рекомендациям и стандартам безопасности, таким как<br/> OWASP Top Ten, для защиты от известных уязвимостей'
        }
      ],
    }
  },
