  ...
  data() {
    return {
      ...
      descriptionTypes: [
        ...
        {
          description: '<b class="strong-text">1. Фильтрация и экранирование входных данных</b>Всегда фильтруйте и экранируйте данные, вводимые пользователями, перед их отображением на web-странице'
        },
        {
        ...
        {
          description: '<b class="strong-text">7. Блокирование нежелательных скриптов</b> Используйте фильтры, которые блокируют нежелательные скрипты и код на сторонних ресурсах, такие как реклама или аналитика'
        },
        {
          description: '<b class="strong-text">8. Соблюдение стандартов безопасности</b> Следуйте рекомендациям и стандартам безопасности, таким как OWASP Top Ten, для защиты от известных уязвимостей'
        }
      ],
    }
  },
