...
<template>
  <div class="mail__container">
      ...
      <div class="mail__messages">
        ...
        >
          ...
          <div class="mail__dialogs__item-content" v-if=mes.isTarget>
            ...
            <p>Перейди по ссылке для заполнения анкеты: <span>
              http://ankets.net
            </span>
            </p>
          </div>
    ...
    <anonymous-modal text-message="<p>Василий Пупкин установил популярный пароль, который был в нашей базе паролей.</p>
                                   <p>Теперь у Вас есть доступ ко всем его сообщениям.</p>
                                   <p>А чтобы такого не случалось в твоей системе, читай рекомендации в разделе “Защита” на главной странице атаки.</p>">
    </anonymous-modal>
  </div>
</template>
